package com.example.oas.api.config;

import cn.dev33.satoken.exception.NotLoginException;
import cn.hutool.json.JSONObject;
import com.example.oas.api.exception.OasException;
...
public class ExceptionAdvice {
    ...
    public String exceptionHandler(Exception e) {
        ...
        //处理业务异常
        else if (e instanceof OasException) {
            log.error("执行异常", e);
            OasException exception = (OasException) e;
